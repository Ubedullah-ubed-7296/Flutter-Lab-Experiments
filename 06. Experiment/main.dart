        ...
        child: Row(
          children: [
            ...
            Column(
              ...
              children: [
                Text("Syed Abid Ali", style: Theme.of(context).textTheme.titleLarge),
                SizedBox(height: 4),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Email: syedabidali@gmail.com", style: Theme.of(context).textTheme.bodyMedium),
            Text("Phone: +91 7569911629", style: Theme.of(context).textTheme.bodyMedium),
          ],
        ),
      ),
    );
